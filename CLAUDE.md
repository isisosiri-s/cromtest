...
- **Light background** (white, light grey, pale tints) → use `brand_assets/logo_if_white.svg`
- **Dark background** (navy, dark gradients, deep colors) → use `brand_assets/logo_if_color.svg`
